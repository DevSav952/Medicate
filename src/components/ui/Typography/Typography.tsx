...
export const H1 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h1 ref={ref} className={twMerge('font-bold text-[46px] text-primary', className)}>
      {children}
    </h1>
  )
})
...
export const H2 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h2 ref={ref} className={twMerge('font-bold text-[36px] text-primary', className)}>
      {children}
    </h2>
  )
})
...
export const H3 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h3 ref={ref} className={twMerge('font-bold text-[26px] text-primary', className)}>
      {children}
    </h3>
  )
})
...
export const H4 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h4 ref={ref} className={twMerge('font-bold text-[24px] text-primary', className)}>
      {children}
    </h4>
  )
})
...
export const H5 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h5 ref={ref} className={twMerge('font-regular text-xl text-primary', className)}>
      {children}
    </h5>
  )
})
...
export const H6 = forwardRef<HTMLHeadingElement, TypographyProps>(({ children, className }, ref) => {
  return (
    <h6 ref={ref} className={twMerge('font-bold text-lg text-primary', className)}>
      {children}
    </h6>
  )
})
